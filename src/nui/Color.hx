...
/**
	...
	Color.hex("#C8323C")      // the same, written the other way
	```
...
abstract Color(String) to String {
	...
	/**
		A colour written as `#rgb` or `#rrggbb`, in either case.
	...
	**/
	...
	/**
		The three components, or null for a role.
	...
	**/
	public static function rgbOf(said:Null<String>):Null<{r:Int, g:Int, b:Int}> {
